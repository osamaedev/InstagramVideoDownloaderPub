...
@Composable
fun InstaDownloaderCircularProgressView(
...
private fun Preview() {
    Column(
        ...
        InstaDownloaderCircularProgressView(indicatorSize = 40.dp, strokeWidth = 5.dp)
        InstaDownloaderCircularProgressView(
            partialDisplay = 0.3f,
            indicatorSize = 32.dp,
            strokeWidth = 4.dp
