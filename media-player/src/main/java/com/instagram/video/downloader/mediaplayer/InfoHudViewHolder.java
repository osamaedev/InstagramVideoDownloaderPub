    ...
    private final Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == MSG_UPDATE_HUD) {
                ...
                setRowValue(R.string.v_cache, String.format(Locale.US, "%s, %s", formattedDurationMilli(videoCachedDuration), formatedSize(videoCachedBytes)));
                setRowValue(R.string.a_cache, String.format(Locale.US, "%s, %s", formattedDurationMilli(audioCachedDuration), formatedSize(audioCachedBytes)));
                ...
                setRowValue(R.string.tcp_speed, String.format(Locale.US, "%s", formattedSpeed(tcpSpeed, 1000)));
