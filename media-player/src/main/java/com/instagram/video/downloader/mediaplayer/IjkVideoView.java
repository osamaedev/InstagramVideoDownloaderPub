...
public class IjkVideoView extends FrameLayout implements MediaController.MediaPlayerControl {
    ...
    private CustomPlayerState customPlayerState;
    ...
    public void setCustomPlayerState(CustomPlayerState customPlayerState) {
        this.customPlayerState = customPlayerState;
    }
    ...
    public void setRenderView(IRenderView renderView) {
        ...
        renderView.getView().setFocusable(false);
                ...
                if (mRenderView != null) {
                    ...
                    if (!mRenderView.shouldWaitForResize() || mSurfaceWidth == mVideoWidth && mSurfaceHeight == mVideoHeight) {
                        ...
                        if (mTargetState == STATE_PLAYING) {
                            start();
                            if (customPlayerState != null) {
                                customPlayerState.onStateChange(STATE_PLAYING);
                            }
                        } else if (!isPlaying() &&
    ...
    private final IMediaPlayer.OnErrorListener mErrorListener =
            new IMediaPlayer.OnErrorListener() {
                public boolean onError(IMediaPlayer mp, int framework_err, int impl_err) {
                    ...
                    mTargetState = STATE_ERROR;
                    if (customPlayerState != null) {
                        customPlayerState.onStateChange(STATE_ERROR);
                    }
                    ...
                    if (getWindowToken() != null) {
                        if (framework_err == MediaPlayer.MEDIA_ERROR_NOT_VALID_FOR_PROGRESSIVE_PLAYBACK) {
                            Log.d(TAG, "onError: ====> VideoView_error_text_invalid_progressive_playback");
                        } else {
                            Log.d(TAG, "onError: ====> VideoView_error_text_unknown");
                        }
...
//        }
    ...
    public static String getRenderText(Context context, int render) {
        ...
        switch (render) {
            case RENDER_NONE:
                text = "VideoView_render_none";
                break;
            case RENDER_SURFACE_VIEW:
                text = "VideoView_render_surface_view";
                break;
            case RENDER_TEXTURE_VIEW:
                text = "VideoView_render_texture_view";
                break;
            default:
                text = "N_A";
                break;
    ...
    public static String getPlayerText(Context context, int player) {
        ...
        switch (player) {
            case Settings.PV_PLAYER__AndroidMediaPlayer:
                text = "VideoView_player_AndroidMediaPlayer";
                break;
            case Settings.PV_PLAYER__IjkMediaPlayer:
                text = "VideoView_player_IjkMediaPlayer";
                break;
            case Settings.PV_PLAYER__IjkExoMediaPlayer:
                text = "VideoView_player_IjkExoMediaPlayer";
                break;
            default:
                text = "N_A";
                break;
...
//                    ijkMediaPlayer.setOption(IjkMediaPlayer.OPT_CATEGORY_PLAYER, "flush_packets", 1L);
                    ...
                    ijkMediaPlayer.setOption(IjkMediaPlayer.OPT_CATEGORY_FORMAT, "probesize", 10000);
                    ijkMediaPlayer.setOption(IjkMediaPlayer.OPT_CATEGORY_FORMAT, "analyzeduration", 10000);
                }
...
//        adBuilder.show();
    ...
    private String buildTrackType(int type) {
        ...
        return switch (type) {
            case ITrackInfo.MEDIA_TRACK_TYPE_VIDEO -> context.getString(R.string.TrackType_video);
            case ITrackInfo.MEDIA_TRACK_TYPE_AUDIO -> context.getString(R.string.TrackType_audio);
            case ITrackInfo.MEDIA_TRACK_TYPE_SUBTITLE ->
                    context.getString(R.string.TrackType_subtitle);
            case ITrackInfo.MEDIA_TRACK_TYPE_TIMEDTEXT ->
                    context.getString(R.string.TrackType_timedtext);
            case ITrackInfo.MEDIA_TRACK_TYPE_METADATA ->
                    context.getString(R.string.TrackType_metadata);
            default -> context.getString(R.string.TrackType_unknown);
        };
    }
